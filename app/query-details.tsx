          ...
          onPress={() => router.push({
            ...
            params: {
              ...
              incident: JSON.stringify({
                id: query.id,
                classification_id: query.classification_id || query.classification?.id,
                location_id: query.location_id || query.location?.id,
                department_id: query.department_id || query.department?.id,
                assignee_id: query.assignee_id || query.assignee?.id,
