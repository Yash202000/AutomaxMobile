          ...
          onPress={() => router.push({
            ...
            params: {
              ...
              incident: JSON.stringify({
                id: complaint.id,
                classification_id: complaint.classification_id || complaint.classification?.id,
                location_id: complaint.location_id || complaint.location?.id,
                department_id: complaint.department_id || complaint.department?.id,
                assignee_id: complaint.assignee_id || complaint.assignee?.id,
