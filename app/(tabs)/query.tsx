...
const QueriesScreen = () => {
  ...
  useFocusEffect(
    useCallback(() => {
      if (statsLoaded) fetchQueries(1, false);
    }, [statsLoaded, activeStateId, priority, severity, assignee_id, department_id, classification_id, location_id, sla_status, channel, searchQuery])
  );
