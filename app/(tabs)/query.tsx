                    ...
                    <>
                        ...
                        <View style={styles.headerIcons}>
                            <TouchableOpacity style={styles.headerIcon} onPress={() => router.push({
                                pathname: '/map-view',
                                params: { type: 'query', state_id, priority, severity, assignee_id, department_id, classification_id, location_id, channel, start_date, end_date, search: searchQuery }
                            })}>
                            ...
                            <TouchableOpacity
                                ...
                                onPress={() => router.push({
                                    ...
                                    params: { state_id, state_name, state_name_ar, priority, severity, assignee_id, assignee_name, department_id, department_name, classification_id, classification_name, location_id, location_name, channel, start_date, end_date }
                                })}
                            >
